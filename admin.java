...
public class admin extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(au)
                        .addComponent(ap, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String s1=au.getText();
        String s2=ap.getText();
        String s3="ADMIN";
        if(s1.equals(s3)&&s2.equals(s3))
        {
            selectco s=new selectco();
            s.setVisible(true);
        }
        else
        {
            JOptionPane.showMessageDialog(null,"WRONG CREDIANTIALS");
        }
